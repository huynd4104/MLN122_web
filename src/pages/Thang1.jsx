...
const FUNCTIONS = [
    {
        ...
        bg: "bg-blue-900/40",
        desc: "Tiền dùng để đo lường và biểu hiện giá trị của hàng hoá (theo giáo trình: Tiền tệ biểu hiện giá trị hàng hóa thông qua giá cả).",
        borderColor: "#60a5fa",
    },
    {
        id: "luu_thong",
        ...
        bg: "bg-amber-900/40",
        desc: "Tiền làm môi giới trong trao đổi hàng hoá (theo giáo trình: Tiền tệ làm trung gian trong lưu thông hàng hóa).",
        borderColor: "#fbbf24",
    },
    {
        id: "cat_tru",
        ...
        desc: "Tiền rút khỏi lưu thông, cất giữ để dành (theo giáo trình: Tiền tệ như phương tiện tích lũy giá trị).",
        borderColor: "#34d399",
    },
    {
        id: "thanh_toan",
        ...
        bg: "bg-purple-900/40",
        desc: "Tiền dùng để trả nợ, trả tiền mua hàng trả chậm (theo giáo trình: Tiền tệ dùng trong thanh toán không đồng thời).",
        borderColor: "#c084fc",
    },
    {
        id: "the_gioi",
        ...
        bg: "bg-sky-900/40",
        desc: "Tiền dùng trong thanh toán và mua bán quốc tế (theo giáo trình: Tiền tệ vượt biên giới, làm phương tiện thanh toán quốc tế).",
        borderColor: "#38bdf8",
    },
];
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 pb-16">
                ...
                {/* ── EVENT CARD ── (Đã hoàn thiện chi tiết hơn) */}
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-start">
                        ...
                        <div>
                            ...
                            <p className="text-blue-200 text-sm leading-relaxed mb-2">
                                Vào ngày <strong className="text-yellow-300">1/1/1999</strong>, đồng Euro (€) chính thức được ra mắt như một đồng tiền kế toán tại <strong className="text-white">11 quốc gia thành viên Liên minh châu Âu (EU)</strong> ban đầu (Áo, Bỉ, Phần Lan, Pháp, Đức, Ireland, Ý, Luxembourg, Hà Lan, Bồ Đào Nha và Tây Ban Nha). Đây là sự kiện lịch sử chưa từng có — lần đầu tiên các quốc gia có chủ quyền tự nguyện từ bỏ đồng tiền quốc gia (như Franc Pháp, Mark Đức, Lira Ý) để dùng chung một đồng tiền thống nhất, nhằm thúc đẩy hội nhập kinh tế và ổn định chính trị.
                            </p>
                            <p className="text-blue-200 text-sm leading-relaxed mb-2">
                                Đến năm <strong className="text-white">2002</strong>, tiền giấy và xu Euro chính thức lưu thông, thay thế hoàn toàn các đồng tiền cũ. Hiện nay, Euro là đồng tiền dự trữ thứ 2 thế giới sau USD, được sử dụng tại <strong className="text-yellow-300">20 quốc gia</strong> trong khu vực Eurozone (bao gồm thêm Hy Lạp, Slovenia, Síp, Malta, Slovakia, Estonia, Latvia, Lithuania, Croatia). Sự ra đời của Euro không chỉ là bước tiến kỹ thuật mà còn phản ánh quy luật kinh tế chính trị Mác - Lênin về sự phát triển của lực lượng sản xuất và quan hệ sản xuất trong chủ nghĩa tư bản hiện đại, nơi tiền tệ trở thành công cụ hội nhập quốc tế và kiểm soát khủng hoảng.
                            </p>
                        </div>
                    </div>
                </motion.section>
